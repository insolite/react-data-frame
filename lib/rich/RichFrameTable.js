...
var RichFrameTable = function (_React$Component) {
    ...
    _createClass(RichFrameTable, [{
        ...
        value: function componentWillMount() {
            ...
            }, this.props.onVisibleDataChange ? function () {
                return _this2.props.onVisibleDataChange(_this2.state.data);
            } : undefined);
        }
    }, {
        key: 'onScrollFrame',
        ...
        value: function onRowClick(row, rowIndex, e) {
            ...
            var _props2 = this.props,
                onSelectedRowsChange = _props2.onSelectedRowsChange,
            ...
            if (e.ctrlKey) {
                ...
                var lastSelectedIndex = data.findIndex(function (row) {
                    return row.id === _this3.lastSelectedId;
                });
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            // TODO: check columns
                    ...
                    }, nextProps.onVisibleDataChange ? function () {
                        return nextProps.onVisibleDataChange(_this4.state.data);
                    } : undefined);
                }
        }
    }, {
        ...
        value: function renderRow(props) {
            ...
            return _react2.default.createElement(this.props.rowComponent, _extends({}, props, {
                onClick: function onClick(e) {
                    return _this5.onRowClick(data, index, e);
                },
        ...
        value: function render() {
            var _props4 = this.props,
                ...
                onSelectedRowsChange = _props4.onSelectedRowsChange,
                sort = _props4.sort,
                onSortChange = _props4.onSortChange,
                externalSort = _props4.externalSort,
                filters = _props4.filters,
                onFiltersChange = _props4.onFiltersChange,
                externalFilters = _props4.externalFilters,
                scrollbarsComponent = _props4.scrollbarsComponent,
                rowHeight = _props4.rowHeight,
                tableProps = _objectWithoutProperties(_props4, ['data', 'children', 'className', 'selectedRows', 'onSelectedRowsChange', 'sort', 'onSortChange', 'externalSort', 'filters', 'onFiltersChange', 'externalFilters', 'scrollbarsComponent', 'rowHeight']);
